...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleStartRecording() {
    const isSpeechRecognitionAPIAvaiable =
    ...
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md text-left flex flex-col bg-slate-700 p-5 gap-3 outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
        ...
        <p className="text-sm leading-6 text-slate-400">
          ...
          possimus veritatis amet, enim sapiente unde consequatur consectetur,
          aut aut aut tempora assumenda beatae doloremque quisquam ex a
          blanditiis ipsa?
        </p>
      </Dialog.Trigger>
